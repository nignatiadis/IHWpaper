...
sim_funs <- lapply(xi_maxs, function(x) wasserman_normal_sim_fun(20000,0.95,1, x))
...
saveRDS(eval_table, file="result_files/wasserman_normal_simulation_benchmark_2.Rds")
