...
vignette: >
  %\VignetteIndexEntry{"Reproduction of Figure 2"}
  %\VignetteEngine{knitr::rmarkdown}
  %\usepackage[utf8]{inputenc}
---

In this vignette we will reproduce Figure 2 of the paper, which includes applications of IHW to RNASeq, proteomics and hQTL data, as well as simulated examples. Also see vignettes "Real data examples" and "Simulation Results" for some of the plots that appear in the supplement (previous versions of this vignette).
...
# Put all panels together for top row of main fig!
...
# Bottom row of main fig (simulations)
