...
null_df <- rbind(readRDS(null_grb_file), readRDS(null_file))
null_df$fdr_method <- sapply(strsplit(null_df$fdr_method," 20"), "[",1)
null_df$fdr_method <- factor(null_df$fdr_method, levels= methods_pretty)
```
...
effsize_df <- rbind(readRDS(effsize_grb_file), readRDS(effsize_file))
effsize_df$fdr_method <- sapply(strsplit(effsize_df$fdr_method," 20"), "[",1)
effsize_df$fdr_method <- factor(effsize_df$fdr_method, levels= methods_pretty)
```
